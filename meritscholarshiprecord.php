...
<html lang="en">
    <head>
        ...
        <title>ISU - ROXAS Merit Scholarship Records</title>
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Merit Scholarship Records</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Merit Scholarship</li>
            </ol>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Records
                    <a href="meritrecord_download.php" class="btn btn-success float-end">Download Records</a>
                </div>
                <div class="card-body">
...
<tr>
    ...
    <td>
        <a href="' . $row['COGimage'] . '" target="_blank">
            <img src="' . $row['COGimage'] . '" alt="COG" oncontextmenu="showDownloadPrompt(event, \'' . $row['COGimage'] . '\');">
        </a>
    </td>
    <td>
        <a href="' . $row['Assessmentimage'] . '" target="_blank">
            <img src="' . $row['Assessmentimage'] . '" alt="Assessment Form" oncontextmenu="showDownloadPrompt(event, \'' . $row['Assessmentimage'] . '\');">
        </a>
    </td>
    <td>
        <a href="' . $row['Schoolidimage'] . '" target="_blank">
            <img src="' . $row['Schoolidimage'] . '" alt="School ID" oncontextmenu="showDownloadPrompt(event, \'' . $row['Schoolidimage'] . '\');">
        </a>
    </td>
    <td>' . date("F j, Y", strtotime($row['application_date'])) . '</td> <!-- Display Date Applied -->
    <td>
        <form action="meritupdatestatus.php" method="post" style="display: inline;">
    ...
    <td>
        <a class="btn btn-primary btn-sm" href="meritscholarshipupdate.php?updateid=' . $row['id'] . '" target="_blank">Update</a>
        <a class="btn btn-danger btn-sm" href="meritdelete.php?deleteid=' . $row['id'] . '">Delete</a>
    </td>
</tr>';
